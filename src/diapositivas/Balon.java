 ...
 * @author JCode
 */
public final class Balon extends Applet {

    private static final long serialVersionUID = 1L;

    public Balon(String filename) {
    ...
    public BranchGroup crearescenaG(String filename) {
        ...
        Alpha zoomAlpha = new Alpha(-1, Alpha.INCREASING_ENABLE | Alpha.DECREASING_ENABLE, 0, 0, 3500, 6000, 26, 1500, 2000, 26);

        Transform3D yAxis = new Transform3D();
        ScaleInterpolator zoom = new ScaleInterpolator(zoomAlpha, escenaTG, yAxis, 2.0f, (float) Math.PI * 1.2f);
        zoom.setSchedulingBounds(limites);
        escenaTG.addChild(zoom);
        ...
        objTrans.setTranslation(new Vector3d(0.0, 0.04, 0.0));
        objTrans.setScale(0.07);
        ...
        try {
            s = file.load(filename == null ? "images\\Balon\\Basketball.obj" : filename);
    ...
    private TransformGroup dibujarfondo() {
        ...
        TextureLoader espacio = new TextureLoader("diapositivas\\Diapositiva2.PNG", this);
