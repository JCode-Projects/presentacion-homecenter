 ...
 * @author JCode
 */
public class Portatil extends Applet {
    ...
    public BranchGroup crearescenaG(String filename){
        ...
        objTrans.setTranslation(new Vector3d(0.0,0.15,0.0));
        ...
        try{
           s = file.load(filename == null ? "images\\Portatil\\6.obj" : filename);
    ...
    private TransformGroup dibujarfondo(){
        ...
        TextureLoader espacio = new TextureLoader("diapositivas\\Diapositiva3.PNG",this);
