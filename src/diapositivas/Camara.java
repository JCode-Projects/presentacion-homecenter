 ...
 * @author JCode
 */
public class Camara extends Applet {
    private static final long serialVersionUID = 1L;
    
    public Camara(String filename){
    ...
    public BranchGroup crearescenaG(String filename){
        ...
        Alpha desplazamientoAlpha = new Alpha(-1, Alpha.INCREASING_ENABLE | Alpha.DECREASING_ENABLE, 0, 0, 3500, 6000, 26, 1500, 2000, 26);
        
        Transform3D yAxis = new Transform3D();
        PositionInterpolator desplazar = new PositionInterpolator(desplazamientoAlpha,escenaTG,yAxis,-0.5f,0.5f);
        desplazar.setSchedulingBounds(limites);
        escenaTG.addChild(desplazar);
        ...
        try{
           s = file.load(filename == null ? "images\\Camara\\14.obj" : filename);
        }
    ...
    private TransformGroup dibujarfondo(){
        ...
        TextureLoader espacio = new TextureLoader("diapositivas\\Diapositiva4.PNG",this);
